...
/**
 * 作品集資料由 Notion 同步而來（PRD §13.1、F-07）。實際內容在 ./works.data.ts，
 * 那份檔案是 `npm run sync:notion` 產生的，不要手改——要改請改 Notion 的「作品集 Works」資料庫。
 * 只有「狀態＝上線」的會被同步下來（§13.5）。
 */
export { WORKS } from './works.data'
